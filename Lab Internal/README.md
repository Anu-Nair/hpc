...
5. [Write an OpenMP program to add all the elements of two arrays A & B each of size 1000 and store their sum in a variable using reduction clause.](7.&#32;Reduction.c)

6. [Write an OpenMP program to find the largest element in an array using critical section.](8.&#32;Critical&#32;Section.c)

7. [Write an OpenMP program to show how thread private clause works.](9.&#32;Thread&#32;Private.c)

8. [Write an OpenMP program to perform addition of two arrays A & B store the result in the array C(scheduling concept)](10.&#32;Addition&#32;of&#32;two&#32;arrays.c)
